...
import com.cejet.pagefactory.PageFactory;
...
public class CEJETStandardSteps extends CEJETBaseStep {
	...
	public void setUp(Scenario s) throws Exception {
		...
		CEJETWebdriverBase.loadInitialURL();
	}

	@After
	public void tearDown(Scenario s) throws Exception {
		try {
			CEJETWebdriverBase.closeBrowser();
